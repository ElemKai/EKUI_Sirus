...
L["Colorize Selected Text"] = "Окрасить выбранный текст"
...
L["Editbox History Size"] = "История EditBox Размер"
...
L["Inactivity Timer"] = "Таймер исчезания"
...
L["Seconds"] = "Секунды"
L["Selected Text Color"] = "Выбранный текстовый цвет"
L["Selector Color"] = "Выбрать цвет"
L["Selector Style"] = "Стиль"
...
Форматы имени:
"name:veryshort" - Имя с ограничением длины в 5 символов
...
Примеры:
"namenp:veryshort" - Имя с ограничением длины в 5 символоs
"namenp:short" - Имя с ограничением длины в 10 символов
"namenp:medium" - Имя с ограничением длины в 15 символов
"namenp:long" - Имя ограничением длины в 20 символов
Остальные варианты дя поля доступны для ознакомления в Теги -> NamePlates
]=]
