...
IM.PinDB = {
	...
	[15]={ --[[ EASTERN KINGDOMS ]]--
		...
		{46.15, 31.12, {874}, "Монастырь Алого ордена"}, --scarlet monastery
	...
	[21]={ --[[ Tirisfall Glades ]]--
		{84.3, 33.2, {874}, "Монастырь Алого ордена"}, --scarlet monastery
	},
	...
	pin:HookScript("OnMouseDown", function(self, button)
		if (button == "LeftButton") then
			if (#subInstanceMapIDs == 1) then
				...
				for i = 1, #subInstanceMapIDs do
					local name = InstanceMapDB[subInstanceMapIDs[i]][1]
					local line = { text = name, notCheckable = true, func = function() IM:ShowInstance(subInstanceMapIDs, i); end }
